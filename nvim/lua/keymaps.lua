...
vim.keymap.set("n", "<leader>bx", ":bd<CR>", { silent = true, desc = "current [b]uffer, [d]elete" })
...
vim.keymap.set("n", "<leader>ls", ":LiveServerStart <CR>", { silent = true })
...
vim.keymap.set("n", "gr", vim.lsp.buf.references, { silent = true, desc = "[g]oto [r]eferences" })
vim.keymap.set("n", "gi", vim.lsp.buf.implementation, { silent = true, desc = "[g]oto [i]mplementations" })
...
-- Marks
vim.keymap.set("n", "<leader>mj", ":Telescope marks<CR>", { desc = "[m]arks, [j]ump" })
